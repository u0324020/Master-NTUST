...
# using : python 6.1 <inputfile> <outputfile> <startRow>
import requests
import time
...
def Curl_Page(ID, url):
    ...
    if "200" in req:
        ...
        try:
            ...
            Epath = "C:/Users/Jane/Desktop/NTU/Scam/Data/txt_ERROR.txt"
...
def Page_text(ID, taarget_url):
    ...
    if str(r.status_code) == "200":
        path = "C:/Users/Jane/Desktop/NTU/Scam/Data/txt - final/" + \
            str(ID) + ".txt"
